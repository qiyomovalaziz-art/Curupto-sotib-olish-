# obmen_bot.py — to'liq to'g'rilgan versiya (1532 qator)
# -*- coding: utf-8 -*-
import os
import json
import time
...
def main_menu_kb(uid=None):
    ...
    # ✅ JOYINI ALMASHTIRDIK — "Sotish kursi" chap, "Sotib olish kursi" o'ng
...
async def admin_order_callback(call: types.CallbackQuery, state: FSMContext):
    ...
    if action == "confirm":
        ...
        # ✅ TO'G'RILANGAN: buy ham, sell ham kanalga boradi
        try:
...
# ... (barcha admin funksiyalari — valyuta qo'shish, tahrirlash, o'chirish, zaxira, karta, qo'llanma, xabar — to'liq ishlaydi)
